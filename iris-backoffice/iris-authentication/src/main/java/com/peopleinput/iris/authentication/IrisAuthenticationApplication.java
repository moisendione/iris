package com.peopleinput.iris.authentication;
...
@ComponentScan(basePackages = {
		...
		"com.peopleinput.iris.authentication"})
public class IrisAuthenticationApplication {

	public static void main(String[] args) {
		SpringApplication.run(IrisAuthenticationApplication.class, args);
	}
